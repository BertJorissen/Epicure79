...
outfile = working_directory."../../results/".machine."/plots/hotspot/plot_".arch."_hotspot_size.eps"
set output outfile
...
data_dir=working_directory."../../results/".machine."/stats/hotspot/".arch."/size/"
...
if(arch eq "cpu"){
	...
	if(machine eq "manticore"){
		outfile = working_directory."../../results/".machine."/plots/hotspot/plot_".arch."_hotspot_size_comp.eps"
		set output outfile

		set key spacing 1 font ",14"

		sycl_dir=working_directory."../../fran/graficas/plothot/"
