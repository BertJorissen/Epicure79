...
CTRL_KERNEL(Hotspot, CPU, DEFAULT, KHitTile_float power, KHitTile_float temp_src, KHitTile_float temp_dst, float Cap_1, float Rx_1, float Ry_1, float Rz_1, float step, {
	int N = thread_id_x - 1;
	int S = thread_id_x + 1;
	int W = thread_id_y - 1;
	int E = thread_id_y + 1;
